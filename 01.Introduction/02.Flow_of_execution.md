...
**High-Level Language:-** Is more near  to human languages (english) they are easy and ledd complex than machine code.
...
* Handles `#include <iostream>` → pulls in the actual code from the iostream header.
* Removes comments.
